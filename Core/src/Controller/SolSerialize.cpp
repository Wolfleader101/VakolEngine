...
namespace Vakol::Controller
{
    ...
    std::function<void(const sol::table&, SolTableData&)> recursiveSolToMap = 
        [&](const sol::table& table, SolTableData& solTableData) 
        {
            ...
            [&](const sol::object& key, const sol::object& value) 
            {
                ...
                if (value.get_type() == sol::type::table)
                    recursiveSolToMap(value.as<sol::table>(), solTableData);
