...
namespace Vakol::Model::Assets 
{
    ...
    public:
        ...
        const unsigned int GetID() const override { return this->m_ID; }
        ...
        void SetVec2v(const std::string& name, const glm::vec2& value) const override;
        void SetVec2(const std::string& name, const float x, const float y) const override;

        void SetVec3v(const std::string& name, const glm::vec3& value) const override;
        void SetVec3(const std::string& name, const float x, const float y, const float z) const override;

        void SetVec4v(const std::string& name, const glm::vec4& value) const override;
        void SetVec4(const std::string& name, const float x, const float y, const float z, const float w) const override;
