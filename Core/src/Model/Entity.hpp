...
namespace Vakol::Model::ECS
{
	...
	public:
		...
		/**
			...
			*/
		Entity(entt::entity handle, EntityList* scene); //this is the intended constructor. Entity = Scene.CreateEntity()
	...
	inline void Entity::AddComponent(Args&&... args)
	{
		if (this->HasComponent<T>())
			VK_ERROR("Entity.AddComponent<>(): Entity already has component... skipping"); //could make it that the new component over writes the old
		else
