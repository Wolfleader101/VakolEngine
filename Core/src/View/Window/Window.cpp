...
namespace Vakol::View
{
        ...
        : m_window(nullptr), m_title(std::move(title)), m_width(width), m_height(height)
    {
        ...
        if (m_window == nullptr)
        {
            ...
            VK_ERROR("2: You are using an OSX Operating System.");
            VK_ERROR("3: You haven't upgraded your graphics drivers to the latest version.");
        }
        ...
        glfwSetKeyCallback(m_window, [](GLFWwindow *window, const int key, [[maybe_unused]] int scancode,
