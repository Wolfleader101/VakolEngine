...
namespace Vakol::View
{
                                  ...
                                  const Model::Assets::Animation& animation) const
    {
        ...
        shader->SetMat4v("BONE_TRANSFORMS", animation.numTransforms(), Math::ToArray(animation.transform()));
    ...
    void GLRenderer::UpdateData(const Controller::Camera& camera)
    {
        ...
        SetBufferSubData(0, 0, sizeof(Math::Mat4), Math::ToArray(PROJECTION));
        SetBufferSubData(0, sizeof(Math::Mat4), sizeof(Math::Mat4), Math::ToArray(VIEW));
        SetBufferSubData(0, 2 * sizeof(Math::Mat4), sizeof(Math::Mat4), Math::ToArray(PROJECTION * VIEW));
    }
