...
namespace Vakol
{
    ...
    // std::pair<std::shared_ptr<Assets::Model>, std::shared_ptr<Animator>> AssetLoader::GetModel(const std::string&
    // file,
    //                                                                                            const float scale,
    //                                                                                            const bool animated,
    //                                                                                            const bool
    ...
    // std::shared_ptr<Terrain> AssetLoader::GetTerrain(const std::string& name, const std::string& heightmap, float
    // min,
    //                                                  float max)
    //{
