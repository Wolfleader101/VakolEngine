...
function start_menu()
    GUI:start_window("Start Menu - Title", true, true, 700, 0.0 , 0, -100); 
    ...
    if windowWidth < WINDOWWIDTHMINIMUM then
        GUI:start_window("Start Menu - Options", true, true, WINDOWWIDTHMINIMUM, 0.0 , 0, 0); 
    elseif windowWidth > WINDOWWIDTHMAXIMUM then
        GUI:start_window("Start Menu - Options", true, true, WINDOWWIDTHMAXIMUM, 0.0 , 0, 0); 
    else
        GUI:start_window("Start Menu - Options", true, true, windowWidth, 0.0 , 0, 0); 
    end
