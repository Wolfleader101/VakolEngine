function init()
	...
	entities[1] = entity;
	models[1] = entities[1]:add_model("coreAssets/models/Imported/OpenGameArt/Yughues/pine/snow_pine_tree.obj", 0.1, false, false);
	...
	models[2] = entities[2]:add_model("coreAssets/models/Imported/OpenGameArt/mastahcez/stone.fbx", 75.0, false, true);
