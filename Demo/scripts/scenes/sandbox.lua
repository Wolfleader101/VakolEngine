function init()
    ...
    --scene:create_entity("test_physics", "entities/test/physics_1.lua");
...
function phys_objs()
    ...
    wall1:get_transform().pos = Vector3.new(-7.5, 10.0, 0.0);
    ...
    wall2:get_transform().pos = Vector3.new(-15.0, 10.0, 0.0);
