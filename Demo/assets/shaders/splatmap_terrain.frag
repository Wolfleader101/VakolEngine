...
void main()
{
    ...
    vec4 color_1 = texture(layer_1, fs_in.TexCoords * (uv_scale * 15)) * texture(noise, fs_in.TexCoords * (uv_scale));
    vec4 color_2 = texture(layer_2, fs_in.TexCoords * (uv_scale * 2)) * texture(noise, fs_in.TexCoords * (uv_scale));
    vec4 color_3 = texture(layer_3, fs_in.TexCoords * (uv_scale * 9.5)) * texture(noise, fs_in.TexCoords * (uv_scale));
